...
class Vgg16():
    ...
    def __init__(self):
        self.FILE_PATH = '/home/bnrc2/.keras/models/'
        self.create()
        self.get_classes()
    ...
    def get_classes(self):
        ...
        fpath = get_file('/home/bnrc2/fast_ai/imagenet_class_index.json',"")
    ...
    def create(self):
        ...
        model.add(Dropout(0.5))
        model.add(Dense(1000, activation='softmax'))
        model.load_weights("/home/bnrc2/.keras/models/vgg16_weights.h5")
